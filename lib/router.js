...
var Router = (function () {
  ...
  _createClass(Router, [{
    ...
    value: function route(path, resolve, name) {
      ...
      var params = [];
      var route = { resolve: resolve, name: name, params: params, path: tokens };
    ...
    value: function resolve(path) {
      ...
      function next(err) {
        ...
        var paramNames = _matches$shift$route.params;

        var promises = {};
        var values = {};

        paramValues = paramValues.map(function (value, i) {
          ...
          return Promise.resolve(value).then(function (v) {
            return resolveParam ? resolveParam(v, promises) : v;
          });
        });

        return Promise.all(paramValues).then(function (values) {
          var params = {};
